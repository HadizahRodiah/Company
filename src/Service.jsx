  ...
  return (
    <div className="w-full bg-slate-900 overflow-x-hidden relative" id="service">
      ...
      <div className="relative z-10">
        {/* Main Section */}
        <div className="p-6 md:p-10 flex flex-col md:flex-row items-center justify-center text-center">
          <div className="w-full md:w-1/2 py-5">
            <h1 className="font-bold text-3xl md:text-6xl text-white mb-4">Our Services</h1>
            <p className="italic p-4 text-base md:text-lg text-gray-300">
              There is nothing serious about this website. Contact the developer for future collaboration.
              Check the <span><a href="#footer" className="underline text-indigo-700">Footer</a></span> for developer's contact. We ensure premium satisfaction.
            </p>
            <h2 className="text-xl md:text-3xl text-white font-bold">A wonderful collaboration!</h2>
          </div>
        </div>
        ...
        <div className="py-10 text-center">
          <h2 className="text-2xl md:text-3xl text-white font-bold">Enjoy a premium experience!</h2>
        </div>
      </div>
    </div>
  );
