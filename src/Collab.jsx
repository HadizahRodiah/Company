...
const Collab = () => {
  return (
    <div className="bg-gray-100 w-full overflow-x-hidden py-8">
      {/* Title Section */}
      <div className="text-black text-center font-bold mb-6 px-4">
        <h1 className="text-3xl md:text-4xl font-serif tracking-wide">Trusted by:</h1>
      </div>

      {/* Logos Section */}
      <div className="px-4 md:px-8 flex flex-wrap justify-center items-center gap-6 md:gap-10">
